...
Nom_Model = "SimCLR"
model_Path = './PytorchModelV3/'+"SimCLR_Model#"+"Full" +"#"+dataset+str(nb_Epoch) +"#" +"FALSE"+".pth"
path_Class = './PytorchModelV3/'+"SimCLR_Class#"+dossier +"#"+dataset+str(nb_Epoch) +"#" +str(BNF)+".pth"
