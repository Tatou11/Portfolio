...
class Classifier(pl.LightningModule):
    ...
    def on_train_end(self):    
        ...
        path_save_data = './Entrainement/'+ dataset + "/Moco_34_Class#"+dossier +"#"+str(nb_Epoch) +"#" +str(BNF)+".csv"
...
plt.title('Matrice')
image_Path = 'M_image_'+dataset+'/'+str(nb_Epoch) +"_" + "EPOCH"+"_" + dossier +"_"+ Nom_Model+"_50_"+str(BNF)+".png"
print(image_Path)
